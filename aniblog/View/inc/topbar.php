...
<header>
	<nav class="pink darken-4">
		<div class="container">
			...
			<a href="<?=ROOT_URL?>blog_index.html" class="brand-logo"><img src="<?=ROOT_URL?>static/img/posts/El_Azhar2.svg" width="300" height="100" class="activator" alt=""></a>
				...
				<ul class="right hide-on-med-and-down">
					...
					<li class="<?php echo ($_GET['a']=="chapters")?"active" : ""; ?>"><a href="<?=ROOT_URL?>blog_chapters.html">Animaux</a></li>
